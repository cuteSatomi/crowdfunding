                ...
                <div class="panel-body">
                    <form action="admin/save.html" method="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input name="userPswd" type="text" class="form-control" id="exampleInputPassword" placeholder="请输入登陆密码">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername">用户昵称</label>
                            <input name="userName" type="text" class="form-control" id="exampleInputUsername" placeholder="请输入用户昵称">
                        </div>
                        <div class="form-group">
